...
(() => {
  ...
  function Component() {
    return /* @__PURE__ */ o2("button", { onClick: () => console.log("hello world!"), children: "Click!" });
  }

  // src/client/page.tsx
  function App() {
    return /* @__PURE__ */ o2("div", { children: [
      /* @__PURE__ */ o2("p", { children: "Hello from the client!" }),
      /* @__PURE__ */ o2("p", { children: /* @__PURE__ */ o2(Component, {}) })
    ] });
  }
  B(/* @__PURE__ */ o2(App, {}), document.getElementById("root"));
})();
